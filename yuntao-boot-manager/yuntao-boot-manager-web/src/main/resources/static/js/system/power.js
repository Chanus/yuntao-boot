...
layui.config({
    ...
    $('#add').on('click', function () {
        popup.open(600, 500, '<i class="layui-icon layui-icon-add-circle"></i>添加权限项', action_path + 'add');
    });
    ...
    table.on('tool(datas)', function (obj) {
        ...
        if (layEvent === 'update') {// 编辑
            popup.open(600, 500, '<i class="layui-icon layui-icon-edit"></i>编辑权限项', action_path + 'update?id=' + data.id);
